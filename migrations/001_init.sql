-- 001_init.sql
-- Initial schema for the RAG pipeline (goose-native format).
--
-- This file consolidates the previous up/down pair into one goose file with
-- explicit Up and Down annotation sections. The SQL content is unchanged.
